      ...
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[300px] w-full">
          <BarChart accessibilityLayer data={chartData} height={250}>
            ...
            <Bar dataKey="upcoming" fill="#FFA725" radius={4} />
            <Bar dataKey="inProgress" fill="#FFF5E4" radius={4} />
            <Bar dataKey="finished" fill="#C1D8C3" radius={4} />
            <Bar dataKey="withDiscrepancy" fill="#7A73D1" radius={4} />
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
