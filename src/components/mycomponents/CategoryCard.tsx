  ...
  return (
    <Card className="relative">
      ...
      <CardFooter className="flex justify-between items-center">
        <Button variant="outline" onClick={() => handleOpenEditDrawer(category)}>
          Edit
        </Button>
      ...
      {/* Delete Modal */}
      {openDeleteModal && <DeleteModal open={openDeleteModal} setOpen={setOpenDeleteModal} type="category" id={category.category_id} />}
    </Card>
  );
};
