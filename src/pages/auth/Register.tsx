...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen relative">
      <Logo />
      <img src="./logo.svg" alt="" className="absolute top-5 left-5" />
      ...
      <div className="w-1/2 h-full hidden md:block">
        <img src="/pexels-chanaka-318741-906494.jpg" alt="Register background" className="w-full h-full object-cover" />
      </div>
    </div>
  );
};
