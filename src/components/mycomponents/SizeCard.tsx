  ...
  return (
    <Card className="relative">
      ...
      <CardFooter className="flex justify-between items-center">
        <Button variant="outline" onClick={() => handleOpenEditDrawer(size)}>
          Edit
        </Button>
      ...
      {/* Delete Modal */}
      {openDeleteModal && <DeleteModal open={openDeleteModal} setOpen={setOpenDeleteModal} type="size" id={size.size_id} />}
    </Card>
  );
};
